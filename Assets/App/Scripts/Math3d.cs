...
public class Math3d : MonoBehaviour
{
    ...
    public static System.ValueTuple<Vector3, Quaternion> RotateAround(Vector3 position, Quaternion rotation, Vector3 center, Vector3 axis, float angle)
    {
        var pos = position;
    ...
    public static System.ValueTuple<Vector3, Quaternion> RotateAround(Vector3 position, Quaternion rotation, Vector3 center, Quaternion targetRotation)
    {
        Vector3 Axis;
        float angleAxis = 0;
    ...
    {
        Vector3 rotationVector = new Vector3(inRotation.x, inRotation.y, inRotation.z); // (rotation axis) * cos(angle / 2)
